...
/// <summary>
/// Unit tests for <see cref="HearNoEvilDetector"/> evaluating hands-to-ears master speaker sound mute triggering.
/// </summary>
public class HearNoEvilDetectorTests
{
    [Fact]
    public void HandsToEars_HoldSatisfied_TriggersSpeakerMute()
    {
        ...
        Assert.True(didToggleSound, "Hear-No-Evil Sound Mute gesture should trigger.");
